...
public class HackerVirus {
	...
	public void defuse() {
		BombInnerWorkings bombContents = new BombInnerWorkings();
		bombContents.actuallyDoDefuse();

		System.out.println("Success! You defused the bomb!");
	}

	private class BombInnerWorkings {

		void actuallyDoDefuse() {
			...
			maybeCheckFourthPassword(passwordScanner);
		}
		...
		private void maybeCheckFourthPassword(Scanner passwordScanner) {
